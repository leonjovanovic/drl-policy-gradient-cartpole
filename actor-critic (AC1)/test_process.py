...
def test_process(parameters, shared_model_actor, counter, end_flag, rewards):
    ...
    if parameters['print_test_results']:
        print("Test process - Step " + str(counter.value) + " Average 10 reward: " + str(np.mean(all_rewards[-10:])) + " Average 100 reward: " + str(np.mean(all_rewards[-100:])))
